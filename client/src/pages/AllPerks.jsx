...
export default function AllPerks() {
  ...
  // 1️⃣ Initial load: fetch all perks once when component mounts
  useEffect(() => {
    loadAllPerks()
  }, [])

  // 2️⃣ Auto-search/filter: whenever searchQuery or merchantFilter changes
  useEffect(() => {
    // Add small debounce (optional)
  ...
  // 3️⃣ Extract unique merchant names from loaded perks
  useEffect(() => {
